...
Protection is adequate and traditional, if a bit spicy at times. 
...
**P1 Original, 5.3R, 70m+**  
Start from the right side of the tears. Climb to a sloping ledge, clipping a bolt. Cross the tears, and gain a right-facing corner. Trend up and left to gain a large scree ledge where a chain station awaits. Protection towards the end of this pitch is marginal, and you will likely need to either simul-climb or split the pitch.  
**P1 Alternate, 4th**  
Stat at the base of the wall, well left of the tears. Climb any of the variety of fourth class options, diagonally up and right, aiming for a large scree ledge and the same chain station described above.   
**P2, 5.8, 50m**  
Just to the left of the tears, there is a right-facing corner system. Climb this for 20m to gain a smaller scree ledge. Above, an easier left-facing corner system continues. Climb this to the top of a pinnacle and chain station belay.   
**P3, 5.4, 25m**  
Traverse rightward across the tears. On the far side, trend up and right, targeting the base of a gorgeous dihedral. A good belay stance can be found by trending further right instead of going high.  
**P4, 5.10+, 45m**  
The money pitch. Climb a beautiful left-facing dihedral on hand jams and finger locks to its top, stepping slightly left below a roof to a chain station belay beside a lovely pool.  
**P5, 5.11 (5.10- A1), 30m**  
The crux pitch. Steep moves off the ground lead to highly technical sequences. The crux moves are protected by a modern bolt. Above, the difficulties ease and lead to engaging pillar climbing.  
This sequence can readily be aided on a self drive, fixed pins, cams, and the bolt, keeping the grade within the 5.10 range. High step the bolt to get cam(s) in the left crack above it, and go back to free climbing.  
Top up water if needed, you'll leave the streak until the top.  
**P6, 5.9, 40m**  
Continue up a chimney for 40m before stepping right to a belay. It may be possible to link this with the previous pitch.  
Greg got lost here repeating his own route. Don't sneak out right at the 30m mark onto an extremely chossy ledge system.  
**P7, 5.10-, 60m**  
...
**Rack**  
Single rack .2-3, doubles .3-2. A full set of nuts. Triple .5 & .75 are useful, as well as a #4.  
Hammers and pins can be left at home.  
