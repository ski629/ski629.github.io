...
{% include figure popup=true  image_path="/assets/images/m14.jpg" caption="The aspirationally named 'M14'." %}
...
{% include figure popup=true  image_path="/assets/images/yogalounge.jpg" caption="The Yoga Lounge" %}
