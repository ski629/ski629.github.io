...
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/gavin p1 s.jpeg" caption="Gavin leading P1 on my next day out" %}
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/p1 anchor.jpeg" caption="Matt at the P1 anchor, this photo might help locate it if it's covered" %}
...
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/guidebook.jpeg" caption="Raph on Stairs and Flowers, from Sean Isaac's Mixed Climbs in the Canadian Rockies" %}
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/p3 m.jpeg" caption="Red is what's left of S&F, yellow is approximately what fell off, green is Addiction" %}
...
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/avalanche.jpg" caption="No attempt to swim, just dejected pole slapping" %}
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/p0.jpeg" caption="Gavin wallows up the approach step" %}
...
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/gavin belay.jpeg" caption="Gavin, wearing two puffies, working hard at the belay" %}
...
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/gregdev.jpeg" caption="This may look like a still photo, but it's actually a 10 minute time lapse of me figuring out where I want the next bolt" %}
...
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/snapped s.jpeg" caption="That is mature timber, blown right over. Overlapping debris from multiple slides really vindicated my decision to lay low for a while." %}
...
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/knot s.jpeg" caption="The offending knot that had caused us to leave a rope behind for a month." %}
...
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/greg send s.jpeg" caption="Your author on the send burn, trying to keep it together to the anchor" %}
...
{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/raph cave s.jpeg" caption="Some say Raph never left that cave" %}

Raph loves good style, and good style to him means _everyone_ sending the crux on lead. I lowered off to the snow ledge so he could take a crack on the sharp end. As is often the case, he made it look like an easy and enjoyable affair. I followed, cleaning the pitch, and then took off up the ice.

{% include figure popup=true  image_path="/assets/images/2026-04-03-addiction/raph style s.jpeg" caption="Raph, styling it. This was moments after a fancy back flag. No one climbs mixed more like a sport rock climber than Raph." %}
...
[Addiction (Youtube)](https://youtu.be/CsuYzi4jNR8)